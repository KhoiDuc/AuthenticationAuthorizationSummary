...
namespace JoseJWTToken.Test.Client
{
    [TestClass]
    public class BasicServiceClientTests
    {
        ...
        public void Authorize_ShouldCallTransportWithPolicy()
        {
            ...
            client.Authorize("name", "buy", new JoseJWTToken.Domain.Service.AuthPolicy(requiredFactors: 2));
        ...
        public void CreateAuthorizationRequest_ShouldCallTransportWithPolicy()
        {
            ...
            client.CreateAuthorizationRequest("name", "buy", new JoseJWTToken.Domain.Service.AuthPolicy(requiredFactors: 2));
        ...
        public void GetAuthorizationResponse_ShouldReturnTransportData()
        {
            ...
            Assert.AreEqual(JoseJWTToken.Domain.Service.AuthorizationResponseType.AUTHORIZED, response.Type);
            Assert.AreEqual(JoseJWTToken.Domain.Service.AuthorizationResponseReason.APPROVED, response.Reason);
        ...
        public void HandleWebhook_AuthPackage_ShouldReturnProperObject()
        {
            ...
            Assert.AreEqual(JoseJWTToken.Domain.Service.AuthorizationResponseType.AUTHORIZED, authResponse.Type);
            Assert.AreEqual(JoseJWTToken.Domain.Service.AuthorizationResponseReason.APPROVED, authResponse.Reason);
        ...
        public void AuthMethodInsight_EmptyGeofencesShouldMatchTransport()
        {
            ...
            List<JoseJWTToken.Domain.Service.Location> emptyLocation = new List<JoseJWTToken.Domain.Service.Location>();
