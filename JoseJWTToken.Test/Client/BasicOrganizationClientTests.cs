...
namespace JoseJWTToken.Test.Client
{
    ...
    public class BasicOrganizationClientTests
    {
        ...
        public void AddServicePublicKey_ShouldCallTransportWithKeyType()
        {
            ...
            var response = client.AddServicePublicKey(serviceId, "keyhere", true, new DateTime(2020, 1, 1), JoseJWTToken.Domain.KeyType.ENCRYPTION);
        ...
        public void AddDirectoryPublicKey_ShouldCallTransportWithKeyType()
        {
            ...
            var response = client.AddDirectoryPublicKey(directoryId, "keyhere", true, new DateTime(2020, 1, 1), JoseJWTToken.Domain.KeyType.SIGNATURE);
