...
namespace JoseJWTToken.Test.Domain.ServiceManager
{
    [TestClass]
    public class ServicePolicyTests
    {
        ...
        public void ToTransport_Variant1()
        {
            ...
            Assert.IsTrue(result.Factors[0].Factor == JoseJWTToken.Transport.Domain.AuthPolicy.FactorType.DeviceIntegrity);
        ...
        public void ToTransport_Variant3()
        {
            ...
            Assert.IsTrue(result.Factors.Count == 1);
            Assert.IsTrue(result.Factors[0].Factor == JoseJWTToken.Transport.Domain.AuthPolicy.FactorType.Geofence);
