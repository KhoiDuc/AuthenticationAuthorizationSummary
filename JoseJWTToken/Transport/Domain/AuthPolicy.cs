...
namespace JoseJWTToken.Transport.Domain
{
    public class AuthPolicy : IPolicy
    {
        ...
        public JoseJWTToken.Domain.Service.Policy.IPolicy FromTransport()
        {
            ...
            JoseJWTToken.Domain.ServiceManager.ServicePolicy parsedLegacyPolicy = JoseJWTToken.Domain.ServiceManager.ServicePolicy.FromTransport(this);
            ...
            foreach (var factor in Factors)
            {
                if (factor.Factor == FactorType.Geofence)
                {
                    foreach (var location in factor.Attributes.Locations)
                        fences.Add(
                            new JoseJWTToken.Domain.Service.Policy.GeoCircleFence(
                                name: location.Name,
            ...
            return new JoseJWTToken.Domain.Service.Policy.LegacyPolicy(
                fences: fences,
