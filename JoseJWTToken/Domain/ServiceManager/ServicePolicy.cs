...
namespace JoseJWTToken.Domain.ServiceManager
{
    /// <summary>
    ...
    public class ServicePolicy
    {
        ...
        public Transport.Domain.AuthPolicy ToTransport()
        {
        ...
        public static ServicePolicy FromTransport(Transport.Domain.AuthPolicy authPolicy)
        {
            bool? jailbreakDetection = null;
            List<Location> locations = null;
            List<TimeFence> timeFences = null;
