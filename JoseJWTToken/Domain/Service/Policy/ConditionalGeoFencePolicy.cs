...
namespace JoseJWTToken.Domain.Service.Policy
{
    ...
    public class ConditionalGeoFencePolicy : IPolicy
    {
        ...
        public Transport.Domain.IPolicy ToTransport()
        {
            ...
            */
            Transport.Domain.IPolicy insidePolicy = Inside.ToTransport();
            insidePolicy.DenyEmulatorSimulator = null;
            insidePolicy.DenyRootedJailbroken = null;

            Transport.Domain.IPolicy outsidePolicy = Outside.ToTransport();
            outsidePolicy.DenyEmulatorSimulator = null;
            outsidePolicy.DenyRootedJailbroken = null;

            return new Transport.Domain.ConditionalGeoFencePolicy(
                inside: insidePolicy,
