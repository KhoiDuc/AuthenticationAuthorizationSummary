...
namespace JoseJWTToken.Client
{
    public class BasicDirectoryClient : IDirectoryClient
    {
        ...
        public Domain.Service.Policy.IPolicy GetAdvancedServicePolicy(Guid serviceId)
        {
            ...
            Transport.Domain.IPolicy response = _transport.DirectoryV3ServicePolicyItemPost(request, _directoryId);
            return response.FromTransport();
        }
        ...
        )
        {
            ...
            if (serverSentEvent is ServerSentEventDeviceLinked)
            {
                ...
                var deviceLinkCompletion = new DeviceLinkCompletionResponse(
